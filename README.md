...
QadamAI — адаптивная двуязычная PWA для цифрового сопровождения пациента после выдачи ТСР. Один интерфейс объединяет ежедневные отчёты, изделия, жалобы с фотографиями, защищённый чат и рабочие кабинеты `PATIENT`, `PRACTITIONER` и `ADMIN`.
...
- AI-выжимка по ТСР, отчётам, жалобам и истории чата для специалиста и администратора;
